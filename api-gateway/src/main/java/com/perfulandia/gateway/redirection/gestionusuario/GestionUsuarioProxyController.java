package com.perfulandia.gateway.redirection.gestionusuario;
...
import com.perfulandia.gateway.jwt.service.JwtService;
...
public class GestionUsuarioProxyController {
    ...
    public ResponseEntity <?> proxyProductos(
        ...
        try {
            ...
            ResponseEntity <String> response = restTemplate
                .exchange(targetUrl, method, entity, String.class)
            ;
            ...
            return ResponseEntity
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .body(
                    "{\"error\": \"Error inesperado en el API Gateway\", \"detalle\": \""+
                    ex.getMessage() +
                    "\"}"
                )
            ;
